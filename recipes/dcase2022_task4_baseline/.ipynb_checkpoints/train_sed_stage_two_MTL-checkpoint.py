...
def single_run(
    ...
    labels_to_mt = {'Alarm_bell_ringing':1, 'Blender':2, 'Cat':1, 'Dishes':1, 'Dog':0, 'Electric_shaver_toothbrush':3, 'Frying':2, 'Running_water':3, 'Speech':0, 'Vacuum_cleaner': 2}
    ...
    if test_state_dict is None:
        ...
        l_param = LossParameter()
        opt = torch.optim.Adam(itertools.chain(sed_student.parameters(), l_param.parameters()), 1e-3, betas=(0.9, 0.999))
